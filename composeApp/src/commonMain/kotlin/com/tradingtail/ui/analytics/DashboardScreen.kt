    ...
    BoxWithConstraints(modifier = modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Band(compact) {
                ...
                PairCell(compact, one, { PlaceholderCard("Average MFE vs MAE", fill) }, { PlaceholderCard("Average Position MAE", fill) })
                PairCell(compact, one, { PlaceholderCard("Average Position MFE", fill) }, { PlaceholderCard("Performance By Instrument Opening Gap", fill) })
            }
            Band(compact) {
                PairCell(compact, one, { KpiTile("Max Consecutive Wins", streaks.maxWins.toString(), modifier = fill) }, { KpiTile("Max Consecutive Losses", streaks.maxLosses.toString(), modifier = fill) })
                PairCell(compact, one, { KpiTile("Total Number of Trades", totalTrades.toString(), modifier = fill) }, { KpiTile("Average Daily Volume", avgDaily, modifier = fill) })
                PairCell(compact, one, { PlaceholderCard("Performance By Instrument Day Type", fill) }, { PlaceholderCard("Performance By Instrument Volume", fill) })
                PairCell(compact, one, { PlaceholderCard("Performance By Symbol Atr", fill) }, { PlaceholderCard("Performance By Rvol", fill) })
            }
            Band(compact) {
                PairCell(compact, one, { PlaceholderCard("Performance By Instrument Movement", fill) }, { PlaceholderCard("Tag Breakdown", fill) })
                if (!compact) {
